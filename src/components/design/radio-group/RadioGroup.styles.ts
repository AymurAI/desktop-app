...
export const RadioWrapper = styled("label", {
	...
	variants: {
		hasText: {
			...
			false: {
				...
				// Focus for radio
				[`& > input:checked:focus-visible + ${RadioCircle}`]: {
					bg: "$$radio_bgFocus_checked",
					b: "$$radio_borderFocus_checked",
				},
				[`& > input:focus-visible + ${RadioCircle}`]: {
	...
	[`& > input:not(:checked) + ${RadioCircle} svg`]: {
		display: "none",
	},
